...
const Sidebar = () => {
  return (
    ...
    //     <div className="absolute top-[42px] left-[36px] flex items-center gap-[10px]">
    //       <img
    //         src={home}
    //         alt="home"
    ...
    //       </p>
    //     </div>
    //     <div className="absolute top-[100px] left-[36px] flex items-center gap-[10px]">
    //       <img
    //         src={home}
    //         alt="notifications"
    //         className="w-[16px] h-[17px] bg-no-repeat bg-left-top bg-transparent opacity-100"
    ...
    <div className="absolute top-[150px] left-[200px] w-[260px] h-[707px] bg-white rounded-[10px] opacity-100">
      <ul className="absolute top-[42px] left-[36px] flex flex-col gap-[40px]">
        {[
          ...
          <li key={index} className="flex items-center gap-[10px] cursor-pointer px-2 py-1 hover:border-l-4 border-transparent hover:border-[#3AC4A0] transition-all duration-200">
            <img
              src={item.icon}
  ...
  <div className="absolute bottom-6 left-[36px] flex items-center gap-[10px] cursor-pointer hover:border-l-4 border-transparent hover:border-[#3AC4A0] px-2 py-1 transition-all duration-200">
    <img
      src={logout} // make sure you have this icon
      alt="logout"
      className="w-[16px] h-[17px] bg-no-repeat bg-left-top bg-transparent opacity-100"
    />
    <p
